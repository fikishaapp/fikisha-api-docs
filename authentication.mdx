...
This method is required when your server or system needs to make calls to Fikisha API endpoints (e.g., `POST /v1/airtime`, `GET /v1/wallet/balance`).

**Credentials:**

You need two pieces of information, which you can generate and manage in the **API Credentials** section of the [Fikisha Vendor Portal Dashboard](https://vendor.fikisha.app/dashboard):
